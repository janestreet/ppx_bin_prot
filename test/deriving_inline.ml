...
module Global_fields_with_localize : sig
  ...
  module Record = struct
    type t =
      { a : Normal.t
      ; mutable b : Mutable.t
      ; c : Global.t [@globalized]
      ; d : Ocaml_global.t [@globalized]
      ; e : Extension_global.t [@globalized]
      }
  ...
  module Tuple_constructor = struct
    type t =
      | T of
          Normal.t
          * (Global.t[@globalized])
          * (Ocaml_global.t[@globalized])
          * (Extension_global.t[@globalized])
    [@@deriving_inline bin_io ~localize ~hide_locations]
...
module With_any_param : sig
  type 'a t = A [@@deriving_inline bin_io, bin_io ~localize]
  ...
  include sig
    ...
    val bin_t : 'a. 'a Bin_prot.Type_class.t -> 'a t Bin_prot.Type_class.t
    val bin_shape_t : Bin_prot.Shape.t -> Bin_prot.Shape.t
    val bin_size_t : 'a. 'a Bin_prot.Size.sizer -> 'a t Bin_prot.Size.sizer
